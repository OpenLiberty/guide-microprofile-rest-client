...
Configure this property to the default [hotspot=2 file=0]`http://localhost:9080/system` base URL:
...
The [hotspot=47-57]`testDefaultLocalhost()` test fetches and compares system properties from the [role="no_copy"]```http://localhost:9080/inventory/systems/localhost``` URL.
