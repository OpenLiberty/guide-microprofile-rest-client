...
You will define the default base URL with host name as `localhost` using MicroProfile Config and CDI method. For example, by default `http://localhost:9080/system` is the base URL of the client.
