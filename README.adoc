...
After you are done checking out the application, stop the Open Liberty server by simply pressing `CTRL+C` in the shell session.
...
When you are done checking out the service, stop the Open Liberty server by simply pressing `CTRL+C` in the shell session where you ran development mode.
