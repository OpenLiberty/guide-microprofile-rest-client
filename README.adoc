...
The URL retrieves the system property information for the `localhost` host name by making a request to the `system` service at http://localhost:9080/system/properties[http://localhost:9080/system/properties^].
