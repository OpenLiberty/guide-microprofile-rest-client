...
:page-seo-title: Consuming RESTful microservices with template interfaces using MicroProfile Rest Client
:page-seo-description: A tutorial on how to consume RESTful Java microservices and instantiate the client with either Context and Dependency Injection (CDI) or RestClientBuilder from MicroProfile Rest Client.
