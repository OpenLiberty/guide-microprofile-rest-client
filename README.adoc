...
The client is configured to automatically follow redirects using the `followRedirects(true)` method. Redirects occur when a RESTful resource has been relocated.
