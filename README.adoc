...
CDI also requires a CDI managed bean to inject the `SystemClient` interface. Since the `InventoryManager` class is another managed bean, add the client here.
