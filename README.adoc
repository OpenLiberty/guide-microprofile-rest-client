...
Then, add two more annotations to the `src/main/java/io/openliberty/guides/inventory/client/SystemClient.java` file so that the interface annotations looks like the following:
